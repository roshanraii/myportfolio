...
import resumePDF from "../src/assets/roshanresume.pdf";
    ...
    function ProjectCarousel() {
      ...
      return (
        <div className="relative w-full overflow-hidden">
          ...
          >
            {PROJECTS.map((p) => (
              <div key={p.title} className="w-full flex-shrink-0 px-0 md:px-0">
                <div className="border-2 p-4 md:p-5" style={{ background: "var(--card)", borderColor: "var(--border)", boxShadow: "var(--shadow)" }}>
                  <div className="flex gap-4 items-start mb-4">
                    <span className="text-3xl flex-shrink-0">{p.icon}</span>
                    <div>
                      <div className="font-black text-base uppercase tracking-wide" style={{ color: "var(--text)", fontFamily: "'Space Grotesk', sans-serif" }}>
                        {p.title}
                      </div>
                      <div className="text-[10px] font-bold uppercase tracking-widest mt-1" style={{ color: "var(--accent)" }}>
                        {p.subtitle}
                      </div>
                  ...
                  <div className="mt-4 pt-3 border-t-2" style={{ borderColor: "var(--border)" }}>
          ...
          <div className="flex justify-between items-center mt-5 gap-3">
            <button
              onClick={prev}
              className="px-4 py-2 border-2 font-black uppercase tracking-widest text-xs"
              style={{
                background: "var(--card)",
                borderColor: "var(--border)",
                color: "var(--text)",
              ...
              {PROJECTS.map((_, i) => (
                <button
                  ...
                  style={{
                    width: 12,
                    height: 12,
                    background: i === current ? "var(--accent)" : "var(--tag)",
                    borderColor: "var(--border)",
                    boxShadow: i === current ? "2px 2px 0px var(--border)" : "none",
   ...
   function ResumeSection() {
     ...
     const handleDownload = () => {
       ...
       link.href = resumePDF;
       link.download = "Roshan_Rai_Resume.pdf";
     ...
     return (
       <Section id="resume" title="Resume">
         <div
           className="border-2 p-6 md:p-8 mb-4"
           style={{
             background: "var(--card)",
             borderColor: "var(--border)",
             boxShadow: "var(--shadow)",
         ...
         >
           <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
             <button
               ...
               className="px-6 py-3 font-black text-sm uppercase tracking-widest border-2 transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
               style={{
                 color: "var(--accent-fg)",
                 background: "var(--accent)",
                 borderColor: "var(--border)",
    ...
    export default function App() {
      ...
      const sections = ["hero", "skills", "experience", "projects", "resume", "education"];
      ...
      return (
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="md:hidden border-2 px-3 py-1 text-sm font-black uppercase tracking-widest"
                style={{
                  color: "var(--text)",
                  borderColor: "var(--border)",
                  background: "var(--card)",
          ...
          {mobileMenuOpen && (
            <div
              className="fixed top-14 left-0 right-0 z-40 border-b-2 p-4 flex flex-col gap-2 md:hidden"
              style={{ background: "var(--bg)", borderColor: "var(--border)" }}
            >
              {sections
                .filter((s) => s !== "hero")
                .map((s) => (
                  <button
                    key={s}
                    onClick={() => scrollTo(s)}
                    className="text-left px-3 py-2 text-sm font-black uppercase tracking-widest border-2"
                    style={{
                      color: activeSection === s ? "var(--accent-fg)" : "var(--text)",
              ...
              <div className="flex gap-3 pt-2 border-t-2" style={{ borderColor: "var(--border)" }}>
                {Object.entries(THEMES).map(([key, t]) => (
                  <button
                    key={key}
                    onClick={() => setThemeKey(key)}
